...
// Resolução de sistemas lineares pelo metodo de Gauss Jacob
...
int main()
{
    ...
    printf("x------------------- Metodo de Gauss Jacob-------------------x\n\n");
    clearCXG();
    readLinearSystem();
    readFromTerminal();
    // printLinearSystem();
